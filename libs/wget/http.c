...
/*   Added for calling the callback function.
 *   This variable is defined in "retr.c"
 *   Added by Yusop */
extern GetFileCallBackFunc g_callBackGetFile;
...
Last-modified header invalid -- time-stamp ignored.\n"));
      ...
      if (use_ts)
	{
       ...
       /*   Added for calling the callback function.
        *   This variable is defined in "retr.c"
        *   The 2nd parameter means that "Download state"
        *   Added by Yusop */
       if(g_callBackGetFile != NULL){
               g_callBackGetFile((int)100,DS_CHECK);
       }
